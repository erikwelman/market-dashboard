...
export function WatchlistRow({ instrument, quote, onSelect, onRemove, onAlert }: WatchlistRowProps) {
    ...
    >
      ...
      {onAlert && (
        <button
          ...
          className="opacity-0 group-hover:opacity-100 text-text-muted hover:text-accent transition-all px-1"
